...
{{
  ...
  },
  {
    ...
    stages =
    {
      sheet =
      {
        filename = "__theMod__/graphics/entity/resources/ferrit-ore.png",
        priority = "extra-high",
        width = 38,
        height = 38,
        frame_count = 4,
    ...
    map_color = {r=0.103, g=0.388, b=0.215}
  },
  {
    type = "item",
    name = "ferrit-ore",
    ...
    order = "a[the-mod-intermediate]-b[ferrit-ore]",
    stack_size = 200
  },
  {
    type = "recipe",
    name = "smelt-ferrit-ore",
    enabled = "true",
	category = "smelting",
    ingredients =
    {
