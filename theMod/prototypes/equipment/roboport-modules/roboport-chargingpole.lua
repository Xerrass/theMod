...
{
    type = "item",
    name = "personal-roboport-module-chargingpole",
    icon = "__base__/graphics/icons/personal-roboport-equipment.png",
    placed_as_equipment_result = "personal-roboport-module-chargingpole",
    flags = {"goes-to-main-inventory"},
    subgroup = "equipment",
    order = "e[robotics]-a[personal-roboport-module-chargingpole]",
    stack_size = 5
  },
{
    type = "roboport-equipment",
    name = "personal-roboport-module-chargingpole",
    take_result = "personal-roboport-module-chargingpole",
    sprite =
    {
  ...
  { 
    ...
    result = "personal-roboport-module-chargingpole"
