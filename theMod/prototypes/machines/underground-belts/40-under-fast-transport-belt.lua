...
{
  {
    ...
    name = "fast-transport-belt-to-ground-40",
    icon = "__base__/graphics/icons/fast-transport-belt-to-ground.png",
    flags = {"placeable-neutral", "player-creation", "fast-replaceable-no-build-while-moving"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "fast-transport-belt-to-ground-40"},
    max_health = 70,
  ...
  },
  {
    ...
    result_count = 2,
    result = "fast-transport-belt-to-ground-40",
  },
{
    type = "item",
    name = "fast-transport-belt-to-ground-40",
    ...
    subgroup = "belt",
    order = "b[transport-belt-to-ground]-a[fast-transport-belt-to-ground-40]",
    place_result = "fast-transport-belt-to-ground-40",
    stack_size = 50
  },
  })