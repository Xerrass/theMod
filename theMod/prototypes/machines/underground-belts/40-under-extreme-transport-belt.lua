...
{
  {
    ...
    name = "express-transport-belt-to-ground-40",
  ...
  },
  {
    ...
    result_count = 2,
    result = "express-transport-belt-to-ground-40"
  },
{
    type = "item",
    name = "express-transport-belt-to-ground-40",
    ...
    subgroup = "belt",
    order = "b[transport-belt-to-ground]-a[express-transport-belt-to-ground-40]",
    place_result = "express-transport-belt-to-ground-40",
    stack_size = 50
  },
  })